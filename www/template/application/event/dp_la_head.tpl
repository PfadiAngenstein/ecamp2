<span metal:define-macro="dp_la_head" tal:omit-tag="">
    <span metal:use-macro="dp_border.tpl/dp_border">
    	...
    	<span metal:fill-slot="border_content" tal:omit-tag="">
            <table width="100%" class="dp_head">
                ...
                <tr>
                    <td id="head_method" style="vertical-align:top" class="single_save head_method">
                    	<textarea id="event_dp_head_method" name="input_edit" class="input_show showtext" style="width:99%" tal:content="dp_head/method/value" ></textarea>
                    </td>
                </tr>
            </table>
        </span>
